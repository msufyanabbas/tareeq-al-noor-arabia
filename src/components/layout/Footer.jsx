...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Facebook, href: '#', label: 'Facebook', color: 'hover:from-blue-600 hover:to-blue-700' },
    { icon: Twitter, href: '#', label: 'Twitter', color: 'hover:from-sky-500 hover:to-sky-600' },
    { icon: Linkedin, href: '#', label: 'LinkedIn', color: 'hover:from-blue-700 hover:to-blue-800' },
    { icon: Instagram, href: '#', label: 'Instagram', color: 'hover:from-pink-600 hover:to-purple-600' },
  ];
          ...
          <Container>
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Get the latest updates on our projects, exclusive offers, and industry insights delivered to your inbox.
              </p>
                  ...
                  <div className="group">
                    <div className="relative">
                      ...
                      <div className="relative flex items-start space-x-4 p-4 lg:p-5 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 hover:border-purple-500/30 transition-all duration-300">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-gray-400 text-sm font-medium mb-1">Business Hours</p>
                          <p className="text-gray-200 text-lg font-bold">
                            24/7 Support
                          </p>
                        </div>
